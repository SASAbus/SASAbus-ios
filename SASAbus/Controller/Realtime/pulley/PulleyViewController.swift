...
class PulleyViewController: MasterViewController, UIScrollViewDelegate, PulleyPassthroughScrollViewDelegate {
    ...
    /**
     ...
     - note: Usage notes: Make 2 container views in Interface Builder and connect their outlets to -primaryContentContainerView and -drawerContentContainerView. 
    ...
    public override func viewDidLayoutSubviews() {
        ...
        let borderPath = UIBezierPath(roundedRect: drawerContentContainer.bounds,
                                      byRoundingCorners: [.topLeft, .topRight], cornerRadii: CGSize(width: drawerCornerRadius, height: drawerCornerRadius)).cgPath
